...
/// Get a single team by slug. Caller must be an organization member.
...
/// Update vault metadata. Currently supports updating retention policy.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Internal sequential InviteId(i64) is used for storage but never appears in the API.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct InviteSlug {
    #[prost(uint64, tag = "1")]
    pub slug: u64,
}
/// Shared invitation view. Field population varies by caller role:
///
/// * Admin callers: invitee_email populated, organization_name empty.
/// * User callers: invitee_email omitted, organization_name populated.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct Invitation {
    ...
    pub organization: ::core::option::Option<OrganizationSlug>,
    #[prost(message, optional, tag = "3")]
    pub inviter: ::core::option::Option<UserSlug>,
    /// Admin reads only
    #[prost(string, tag = "4")]
    pub invitee_email: ::prost::alloc::string::String,
    /// User reads only
    #[prost(string, tag = "5")]
    pub organization_name: ::prost::alloc::string::String,
    #[prost(enumeration = "OrganizationMemberRole", tag = "6")]
    pub role: i32,
    #[prost(message, optional, tag = "7")]
    pub team: ::core::option::Option<TeamSlug>,
    #[prost(enumeration = "InvitationStatus", tag = "8")]
    pub status: i32,
    #[prost(message, optional, tag = "9")]
    pub created_at: ::core::option::Option<::prost_types::Timestamp>,
    #[prost(message, optional, tag = "10")]
...
pub struct ListOrganizationInvitesRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub caller: ::core::option::Option<UserSlug>,
    #[prost(enumeration = "InvitationStatus", optional, tag = "3")]
...
pub struct ListReceivedInvitationsRequest {
    ...
    #[prost(message, optional, tag = "1")]
    pub user: ::core::option::Option<UserSlug>,
    #[prost(enumeration = "InvitationStatus", optional, tag = "2")]
    pub status_filter: ::core::option::Option<i32>,
    #[prost(bytes = "vec", optional, tag = "3")]
    pub page_token: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(uint32, tag = "4")]
...
/// All transitions originate from PENDING. Terminal states are immutable.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
impl InvitationStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Declined => "INVITATION_STATUS_DECLINED",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "INVITATION_STATUS_DECLINED" => Some(Self::Declined),
...
pub mod organization_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Get a single team by slug. Caller must be an org member.
        /// Non-admin members can only see teams they belong to.
        pub async fn get_organization_team(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOrganizationTeamRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOrganizationTeamResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.OrganizationService/GetOrganizationTeam",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        /// Add a member to a team. Caller must be org admin or team manager.
        pub async fn add_team_member(
            &mut self,
            request: impl tonic::IntoRequest<super::AddTeamMemberRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AddTeamMemberResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.OrganizationService/AddTeamMember",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("ledger.v1.OrganizationService", "AddTeamMember"),
                );
            self.inner.unary(req, path, codec).await
        }
        /// Remove a member from a team. Caller must be org admin or team manager.
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.OrganizationService/RemoveTeamMember",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("ledger.v1.OrganizationService", "RemoveTeamMember"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod organization_service_server {
    ...
    pub trait OrganizationService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_organization_team(
            &self,
            request: tonic::Request<super::GetOrganizationTeamRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOrganizationTeamResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/ledger.v1.OrganizationService/GetOrganizationTeam" => {
                    #[allow(non_camel_case_types)]
                    struct GetOrganizationTeamSvc<T: OrganizationService>(pub Arc<T>);
                    impl<
                        T: OrganizationService,
                    > tonic::server::UnaryService<super::GetOrganizationTeamRequest>
                    for GetOrganizationTeamSvc<T> {
                        type Response = super::GetOrganizationTeamResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrganizationService>::get_organization_team(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetOrganizationTeamSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/ledger.v1.OrganizationService/AddTeamMember" => {
                    #[allow(non_camel_case_types)]
                    struct AddTeamMemberSvc<T: OrganizationService>(pub Arc<T>);
                    impl<
                        T: OrganizationService,
                    > tonic::server::UnaryService<super::AddTeamMemberRequest>
                    for AddTeamMemberSvc<T> {
                        type Response = super::AddTeamMemberResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrganizationService>::add_team_member(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/ledger.v1.OrganizationService/RemoveTeamMember" => {
                    #[allow(non_camel_case_types)]
                    struct RemoveTeamMemberSvc<T: OrganizationService>(pub Arc<T>);
                    impl<
                        T: OrganizationService,
                    > tonic::server::UnaryService<super::RemoveTeamMemberRequest>
                    for RemoveTeamMemberSvc<T> {
                        type Response = super::RemoveTeamMemberResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrganizationService>::remove_team_member(
                                        &inner,
                                        request,
                                    )
                                    .await
...
pub mod vault_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Update vault metadata (retention policy).
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.VaultService/UpdateVault",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ledger.v1.VaultService", "UpdateVault"));
            self.inner.unary(req, path, codec).await
        }
    }
}
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/ledger.v1.VaultService/UpdateVault" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateVaultSvc<T: VaultService>(pub Arc<T>);
                    impl<
                        T: VaultService,
                    ...
                    for UpdateVaultSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as VaultService>::update_vault(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod invitation_service_client {
    ...
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    /// Organization invitation lifecycle management.
    /// Admin operations require org admin authorization.
    /// User operations require authenticated user with matching email HMAC.
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Returns the raw token once (for Control to embed in the email URL).
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.InvitationService/CreateOrganizationInvite",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "ledger.v1.InvitationService",
                        "CreateOrganizationInvite",
                    ),
                );
            self.inner.unary(req, path, codec).await
        }
        /// List invitations created by an organization (admin view).
        pub async fn list_organization_invites(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOrganizationInvitesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListOrganizationInvitesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.InvitationService/ListOrganizationInvites",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        /// Get a single invitation by slug (admin view).
        pub async fn get_organization_invite(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOrganizationInviteRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOrganizationInviteResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.InvitationService/GetOrganizationInvite",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        /// Revoke a pending invitation. CAS-guarded (Pending-only).
        pub async fn revoke_organization_invite(
            &mut self,
            request: impl tonic::IntoRequest<super::RevokeOrganizationInviteRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RevokeOrganizationInviteResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.InvitationService/RevokeOrganizationInvite",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        /// Scans all verified email HMACs and unions results.
        pub async fn list_received_invitations(
            &mut self,
            request: impl tonic::IntoRequest<super::ListReceivedInvitationsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListReceivedInvitationsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.InvitationService/ListReceivedInvitations",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        /// Get invitation details for the authenticated user.
        /// Returns NOT_FOUND for both non-existent and unauthorized slugs.
        pub async fn get_invitation_details(
            &mut self,
            request: impl tonic::IntoRequest<super::GetInvitationDetailsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetInvitationDetailsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.InvitationService/GetInvitationDetails",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        /// Accept a pending invitation. Grants org membership and optional team membership.
        /// GLOBAL-first proposal ordering. Partial failure recovery on retry.
        pub async fn accept_invitation(
            &mut self,
            request: impl tonic::IntoRequest<super::AcceptInvitationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AcceptInvitationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.InvitationService/AcceptInvitation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("ledger.v1.InvitationService", "AcceptInvitation"),
                );
            self.inner.unary(req, path, codec).await
        }
        /// Decline a pending invitation. CAS-guarded (Pending-only).
        pub async fn decline_invitation(
            &mut self,
            request: impl tonic::IntoRequest<super::DeclineInvitationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeclineInvitationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.InvitationService/DeclineInvitation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("ledger.v1.InvitationService", "DeclineInvitation"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod invitation_service_server {
    ...
    #[async_trait]
    pub trait InvitationService: std::marker::Send + std::marker::Sync + 'static {
        /// Create an invitation for an email address to join an organization.
        /// Returns the raw token once (for Control to embed in the email URL).
        ...
        async fn list_organization_invites(
            &self,
            request: tonic::Request<super::ListOrganizationInvitesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListOrganizationInvitesResponse>,
            tonic::Status,
        >;
        ...
        async fn get_organization_invite(
            &self,
            request: tonic::Request<super::GetOrganizationInviteRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOrganizationInviteResponse>,
            tonic::Status,
        >;
        ...
        async fn revoke_organization_invite(
            &self,
            request: tonic::Request<super::RevokeOrganizationInviteRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RevokeOrganizationInviteResponse>,
            tonic::Status,
        >;
        ...
        async fn list_received_invitations(
            &self,
            request: tonic::Request<super::ListReceivedInvitationsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListReceivedInvitationsResponse>,
            tonic::Status,
        >;
        ...
        async fn get_invitation_details(
            &self,
            request: tonic::Request<super::GetInvitationDetailsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetInvitationDetailsResponse>,
            tonic::Status,
        >;
        ...
        async fn accept_invitation(
            &self,
            request: tonic::Request<super::AcceptInvitationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AcceptInvitationResponse>,
            tonic::Status,
        >;
        ...
        async fn decline_invitation(
            &self,
            request: tonic::Request<super::DeclineInvitationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeclineInvitationResponse>,
            tonic::Status,
        >;
    ...
    /// User operations require authenticated user with matching email HMAC.
    #[derive(Debug)]
    pub struct InvitationServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> InvitationServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/ledger.v1.InvitationService/CreateOrganizationInvite" => {
                    #[allow(non_camel_case_types)]
                    struct CreateOrganizationInviteSvc<T: InvitationService>(pub Arc<T>);
                    impl<
                        T: InvitationService,
                    ...
                    for CreateOrganizationInviteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InvitationService>::create_organization_invite(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/ledger.v1.InvitationService/ListOrganizationInvites" => {
                    #[allow(non_camel_case_types)]
                    struct ListOrganizationInvitesSvc<T: InvitationService>(pub Arc<T>);
                    impl<
                        T: InvitationService,
                    > tonic::server::UnaryService<super::ListOrganizationInvitesRequest>
                    for ListOrganizationInvitesSvc<T> {
                        type Response = super::ListOrganizationInvitesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::ListOrganizationInvitesRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InvitationService>::list_organization_invites(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListOrganizationInvitesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/ledger.v1.InvitationService/GetOrganizationInvite" => {
                    #[allow(non_camel_case_types)]
                    struct GetOrganizationInviteSvc<T: InvitationService>(pub Arc<T>);
                    impl<
                        T: InvitationService,
                    > tonic::server::UnaryService<super::GetOrganizationInviteRequest>
                    for GetOrganizationInviteSvc<T> {
                        type Response = super::GetOrganizationInviteResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InvitationService>::get_organization_invite(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetOrganizationInviteSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/ledger.v1.InvitationService/RevokeOrganizationInvite" => {
                    #[allow(non_camel_case_types)]
                    struct RevokeOrganizationInviteSvc<T: InvitationService>(pub Arc<T>);
                    impl<
                        T: InvitationService,
                    > tonic::server::UnaryService<super::RevokeOrganizationInviteRequest>
                    for RevokeOrganizationInviteSvc<T> {
                        type Response = super::RevokeOrganizationInviteResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::RevokeOrganizationInviteRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InvitationService>::revoke_organization_invite(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RevokeOrganizationInviteSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/ledger.v1.InvitationService/ListReceivedInvitations" => {
                    #[allow(non_camel_case_types)]
                    struct ListReceivedInvitationsSvc<T: InvitationService>(pub Arc<T>);
                    impl<
                        T: InvitationService,
                    > tonic::server::UnaryService<super::ListReceivedInvitationsRequest>
                    for ListReceivedInvitationsSvc<T> {
                        type Response = super::ListReceivedInvitationsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::ListReceivedInvitationsRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InvitationService>::list_received_invitations(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListReceivedInvitationsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/ledger.v1.InvitationService/GetInvitationDetails" => {
                    #[allow(non_camel_case_types)]
                    struct GetInvitationDetailsSvc<T: InvitationService>(pub Arc<T>);
                    impl<
                        T: InvitationService,
                    > tonic::server::UnaryService<super::GetInvitationDetailsRequest>
                    for GetInvitationDetailsSvc<T> {
                        type Response = super::GetInvitationDetailsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InvitationService>::get_invitation_details(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetInvitationDetailsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/ledger.v1.InvitationService/AcceptInvitation" => {
                    #[allow(non_camel_case_types)]
                    struct AcceptInvitationSvc<T: InvitationService>(pub Arc<T>);
                    impl<
                        T: InvitationService,
                    > tonic::server::UnaryService<super::AcceptInvitationRequest>
                    for AcceptInvitationSvc<T> {
                        type Response = super::AcceptInvitationResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InvitationService>::accept_invitation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AcceptInvitationSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/ledger.v1.InvitationService/DeclineInvitation" => {
                    #[allow(non_camel_case_types)]
                    struct DeclineInvitationSvc<T: InvitationService>(pub Arc<T>);
                    impl<
                        T: InvitationService,
                    > tonic::server::UnaryService<super::DeclineInvitationRequest>
                    for DeclineInvitationSvc<T> {
                        type Response = super::DeclineInvitationResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InvitationService>::decline_invitation(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeclineInvitationSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for InvitationServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "ledger.v1.InvitationService";
    impl<T> tonic::server::NamedService for InvitationServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod token_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Revoke all sessions for an app (increments app token version).
        pub async fn revoke_all_app_sessions(
            &mut self,
            request: impl tonic::IntoRequest<super::RevokeAllAppSessionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RevokeAllAppSessionsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ledger.v1.TokenService/RevokeAllAppSessions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("ledger.v1.TokenService", "RevokeAllAppSessions"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod token_service_server {
    ...
    pub trait TokenService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn revoke_all_app_sessions(
            &self,
            request: tonic::Request<super::RevokeAllAppSessionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RevokeAllAppSessionsResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/ledger.v1.TokenService/RevokeAllAppSessions" => {
                    #[allow(non_camel_case_types)]
                    struct RevokeAllAppSessionsSvc<T: TokenService>(pub Arc<T>);
                    impl<
                        T: TokenService,
                    > tonic::server::UnaryService<super::RevokeAllAppSessionsRequest>
                    for RevokeAllAppSessionsSvc<T> {
                        type Response = super::RevokeAllAppSessionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TokenService>::revoke_all_app_sessions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RevokeAllAppSessionsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
