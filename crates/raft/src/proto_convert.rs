...
//! domain types (from `ledger_types`) and proto types (generated by prost).
//!
//! # Design
//!
...
use ledger_types::merkle::MerkleProof as InternalMerkleProof;
use openraft::Vote;
...
// =============================================================================
// Operation conversions (ledger_types::Operation <-> proto::Operation)
// =============================================================================

impl From<&ledger_types::Operation> for proto::Operation {
    fn from(op: &ledger_types::Operation) -> Self {
...
// =============================================================================
// SetCondition conversions (ledger_types::SetCondition <-> proto::SetCondition)
// =============================================================================

impl From<&ledger_types::SetCondition> for proto::SetCondition {
    fn from(c: &ledger_types::SetCondition) -> Self {
...
mod tests {
    ...
    fn test_condition_must_not_exist() {
        let condition = ledger_types::SetCondition::MustNotExist;
    ...
    fn test_condition_must_exist() {
        let condition = ledger_types::SetCondition::MustExist;
        let proto: proto::SetCondition = (&condition).into();
    ...
    fn test_condition_version_equals() {
        let condition = ledger_types::SetCondition::VersionEquals(42);
        let proto: proto::SetCondition = (&condition).into();
    ...
    fn test_condition_value_equals() {
        let condition = ledger_types::SetCondition::ValueEquals(vec![1, 2, 3, 4]);
        let proto: proto::SetCondition = (&condition).into();
    ...
    fn test_operation_create_relationship() {
        let op = ledger_types::Operation::CreateRelationship {
    ...
    fn test_operation_delete_relationship() {
        let op = ledger_types::Operation::DeleteRelationship {
    ...
    fn test_operation_set_entity_simple() {
        let op = ledger_types::Operation::SetEntity {
    ...
    fn test_operation_set_entity_with_condition_and_ttl() {
        let op = ledger_types::Operation::SetEntity {
            ...
            value: vec![1, 2, 3],
            condition: Some(ledger_types::SetCondition::MustNotExist),
    ...
    fn test_operation_delete_entity() {
        let op = ledger_types::Operation::DeleteEntity {
    ...
    fn test_operation_expire_entity() {
        let op = ledger_types::Operation::ExpireEntity {
    ...
    fn test_vault_entry_to_proto_block_empty_transactions() {
        ...
        let entry = ledger_types::VaultEntry {
            namespace_id: 1,
            vault_id: 2,
            vault_height: 10,
        ...
        let shard_block = ledger_types::ShardBlock {
            shard_id: 1,
            shard_height: 100,
    ...
    fn test_vault_entry_to_proto_block_with_transaction() {
        ...
        let tx = ledger_types::Transaction {
            ...
            sequence: 1,
            operations: vec![ledger_types::Operation::CreateRelationship {
