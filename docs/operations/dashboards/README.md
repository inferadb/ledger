...
Pre-built dashboard templates for monitoring InferaDB Ledger via structured request logging.

For Prometheus/Grafana metrics dashboards (API performance, Raft health, storage engine, resource saturation), see [`docs/dashboards/`](../../dashboards/) which contains the dedicated JSON files.
